package com.sample.exclusivegateway;
...
public class TestExclusiveGateWay {
	...
	public void develpomentProcessDefinition() {
		...
		Deployment deployment = processEngine.getRepositoryService().createDeployment().name("getWayProcess").addClasspathResource("diagrams/exclusiveGateWay.bpmn").addClasspathResource("diagrams/exclusiveGateWay.png").deploy();
	...
	public void completeMyPersonTask() {
		String taskId = "55004";// 参考任务ID:52504
		ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
